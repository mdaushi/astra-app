...
class PengajuanPerjalananDinasPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, PengajuanPerjalananDinas $pengajuanPerjalananDinas)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, PengajuanPerjalananDinas $pengajuanPerjalananDinas)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, PengajuanPerjalananDinas $pengajuanPerjalananDinas)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, PengajuanPerjalananDinas $pengajuanPerjalananDinas)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, PengajuanPerjalananDinas $pengajuanPerjalananDinas)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, PengajuanPerjalananDinas $pengajuanPerjalananDinas)
    {
