...
class PlanPengajuanPerjalananDinas extends Model
{
    use HasFactory;

    protected $table = 'plan_pengajuan_dinas';
    ...
    {
        return $this->hasMany(PlanKegiatanPengajuanPerjalananDinas::class, 'pengajuan_perjalanan_dinas_id');
    }
